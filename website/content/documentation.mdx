...
<PropTable items={[
  ...
  { name: "triggerOffset", type: "number | `${number}%`", default: "0", description: "Tracking offset from top used for the trigger line" },
  ...
  { name: "behavior", type: "'smooth' | 'instant' | 'auto'", default: "'auto'", description: "Scroll behavior. 'auto' respects prefers-reduced-motion and falls back to 'smooth'" },
  { name: "scrollTo", type: "ScrollToOptions", default: "undefined", description: "Default options for scrollTo/link (position, offset, behavior, lockActive)" },
]} />
