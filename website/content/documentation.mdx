...
---
<Demo src="examples/basic" />

   is a lightweight scroll spy hook for React. Track which section is in view, highlight nav items, and build smooth scrolling experiences.
